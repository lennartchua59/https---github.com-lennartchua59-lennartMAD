 ...
 */
     ...
     return (
		...
		<Text style={styles.welcome}>ReminDING</Text>
			 ...
			 <TouchableOpacity
                ...
                ><View style={styles.iconarrow2}><Icon2 name="keyboard-arrow-left" size={30} color="white" />
				</View>
                </TouchableOpacity>
 ...
 <Text style={styles._txt2}>Appearance</Text>
             ...
             <View style={styles._rectangle}>
                 ...
                 <TouchableOpacity
                    onPress={() => props.navigation.navigate('Wapp')}
                    
					
                ><View style={styles.iconcheck1}>
                <Icon name="checkbox-blank-circle-outline" size={40} color="white" />
            </View>
                </TouchableOpacity>
             
                
                 <View style={styles.iconcheck2}>
                     <Icon name="checkbox-marked-circle" size={40} color="white" />
                 </View>
